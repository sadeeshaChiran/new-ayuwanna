        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 '>
          ...
          <motion.div className='grid content-center h-full px-5 mb-28 lg:mb-0 lg:px-100 lg-about-background'>
            ...
            <motion.h1
              ...
              className='mt-6 mb-6 text-4xl font-bold tracking-tight text-center text-black sm:text-7xl lg:text-5xl lg:text-start sm:mb-10 lg:mb-6'>
              {Topic}
            </motion.h1>
            {/* ----------------------------- */}
            ...
            {Paragraph.map((item) => (
              <>
                <motion.p
                  ...
                  className='text-base text-justify text-gray-950 sm:text-2xl lg:text-base me-2 ms-2 sm:me-16 sm:ms-16 lg:me-0 lg:ms-0'>
                  {item.about}
                </motion.p>
                <br />
              </>
